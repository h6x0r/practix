          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {globalPlan && (
              <div
                ...
                data-selected={
                  selectedPlanId === globalPlan.id ? "true" : "false"
                }
                onClick={() => {
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-900 dark:text-white">
                      {formatPrice(globalPlan.priceMonthly)}{" "}
              ...
              <div className="space-y-3">
                {coursePlans.map((plan, index) => (
                  <div
                    ...
                    data-selected={
                      selectedPlanId === plan.id ? "true" : "false"
                    }
                    onClick={() => {
            ...
            <div className="sticky top-24 bg-white dark:bg-dark-surface rounded-2xl border border-gray-200 dark:border-dark-border p-6 space-y-6">
                ...
                <div className="p-4 bg-gray-50 dark:bg-dark-bg rounded-xl">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center text-xl">
                      {selectedPlan.type === "global"
                        ? "👑"
                        : selectedPlan.course?.icon || "📚"}
                    </div>
                    <div className="flex-1">
                      <div className="font-bold text-gray-900 dark:text-white text-sm">
                        {language === "ru"
                          ? selectedPlan.nameRu || selectedPlan.name
                          : selectedPlan.name}
                      </div>
                      <div className="text-xs text-gray-500">
                        {language === "ru" ? "1 месяц" : "1 month"}
                      </div>
                    </div>
                  </div>
              ...
              <button
                ...
                disabled={
                  ...
                  checkoutLoading ||
                  !providers.some(
                    (p) => p.id === selectedProvider && p.configured,
                  )
                }
