...
// Lazy wrapper helper
const lazyWithSuspense = (importFn: () => Promise<{ default: React.ComponentType }>) => {
...
const PlaygroundPage = lazyWithSuspense(() => import('../features/playground/ui/PlaygroundPage'));
const TaskWorkspace = lazyWithSuspense(() => import('../features/tasks/ui/TaskWorkspace'));
const AnalyticsPage = lazyWithSuspense(() => import('../features/analytics/ui/AnalyticsPage'));
const AdminDashboard = lazyWithSuspense(() => import('../features/admin/ui/AdminDashboard'));
const DashboardPage = lazyWithSuspense(() => import('../features/dashboard/ui/DashboardPage'));
